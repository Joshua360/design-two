  ...
  <div class="container-fluid p-0">
    ...
    <div id="rev_slider_home_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="news-gallery34" style="margin:0px auto;background-color:#ffffff;padding:0px;margin-top:0px;margin-bottom:0px;">
      ...
      <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
        <ul>
          <!-- SLIDE 1 -->
          <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="stuff/one.jpg" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
            <!-- MAIN IMAGE -->
            <img src="stuff/one.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
            <!-- LAYERS -->
            <!-- LAYER NR. 1 -->
            ...
            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
              ...
              data-splitout="none" 
              data-responsive_offset="on" 
              style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">Welcome  to <span class="text-theme-colored2"> Kenya's </span> number one <span class="text-theme-color-2">supplier of</span> farm machinery.
            </div>
            <!-- LAYER NR. 3 -->
            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
              id="slide-1-layer-3" 
            ...
            <div class="tp-caption rs-parallaxlevel-0" 
              ...
              data-responsive_offset="on" 
              data-responsive="off"
              style="z-index: 8; white-space: nowrap;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;"><a href="our-shop.php" class="btn btn-default btn-theme-colored2 btn-xl">Visit shop</a> <a href="about.php" class="btn btn-dark btn-theme-colored2 btn-xl">About us</a>
            </div>
          </li>

          <!-- SLIDE 2 -->
          <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="stuff/two.jpg" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
            <!-- MAIN IMAGE -->
            <img src="stuff/two.jpg" alt="" data-bgposition="top 30%" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
            <!-- LAYERS -->
            <!-- LAYER NR. 1 -->
            <div class="tp-caption tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
              id="slide-2-layer-1" 
            ...
            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
              ...
              data-splitout="none" 
              data-responsive_offset="on" 
              style="z-index: 7; white-space: nowrap;">Our team
            </div>
            <!-- LAYER NR. 2 -->
            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
              id="slide-2-layer-3" 
              ...
              data-splitout="none" 
              data-responsive_offset="on" 
              style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">Provides<span class="text-theme-colored2"> techical</span> support <span class="text-theme-colored2">to</span> our clients.
            </div>
            <!-- LAYER NR. 4 -->
            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
              id="slide-1-layer-4" 
              ...
              data-splitout="none" 
              data-responsive_offset="on" 
              style="z-index: 7; white-space: nowrap;"> Our team of experts are always happy to show you how to use these products.
            </div>
            <!-- LAYER NR. 5 -->
            <div class="tp-caption rs-parallaxlevel-0" 
              id="slide-2-layer-5" 
              ...
              data-responsive_offset="on" 
              data-responsive="off"
              style="z-index: 8; white-space: nowrap;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;"><a href="#" class="btn btn-dark btn-theme-colored2 btn-xl">Read More</a>
            </div>
          </li>

          <!-- SLIDE 3 -->
          <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="stuff/five.jpg" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
            <!-- MAIN IMAGE -->
            <img src="stuff/five.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
            <!-- LAYERS -->
            <!-- LAYER NR. 1 -->
            <div class="tp-caption tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
              id="slide-3-layer-1" 
            ...
            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
              ...
              data-splitout="none" 
              data-responsive_offset="on" 
              style="z-index: 6; min-width: 600px; max-width: 600px; white-space: normal;">Get fast <span class="text-theme-colored2">and reliable</span> water pumpting solutions
            </div>
            <!-- LAYER NR. 3 -->
            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
              id="slide-3-layer-3" 
            ...
            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
              ...
              data-splitout="none" 
              data-responsive_offset="on" 
              style="z-index: 7; white-space: nowrap;"><a href="our-shop.php" class="btn btn-dark btn-theme-colored2 btn-xl">BUY NOW</a>
            </div>
            <!-- LAYER NR. 4 -->
            <div class="tp-caption rs-parallaxlevel-0" 
              id="slide-3-layer-4" 
  ...
  <div class="container">
    <div class="section-content">
      <div class="row">
        ...
        <div class="col-md-6">
          <h2 class="text-uppercase mt-0 mt-sm-30">Who We Are</h2>
          <h4 class="text-theme-colored">Welcome to Kenya's number one supplier of farm machinery!</h4>
          <p>IKONIC LTD deals with importing, assembling, marketing and promotion of labor-saving agricultural technologies targeting mainly smallholder farmers with up to 20 acres of land. We supply farm machinery to cross-cutting value chains such as dairy, beef, poultry and horticultural value chains, as well as accelerate smallholder farmers into actors of key markets.

</p>
           
            <a href="about-us.php" class="btn btn-flat btn-colored btn-theme-colored mt-15 mr-15">Read More</a>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="section-content">
         <div class="row">
            ...
            <div class="col-md-7">
              ...
              <p class="mb-20">WE ARE THE LEADING SUPPLIER OF AGRICULTURAL MACHINERY</p>
...
<section class="divider parallax layer-overlay overlay-theme-colored-2" data-bg-img="images/bg/bh5.jpg" data-parallax-ratio="0.7">
  <div class="container">
    <div class="section-content text-center">
      <div class="row">
        <div class="col-md-12">
          <h2 class="mt-0 mb-50 text-white">Our Clients and Partners</h2>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="owl-carousel-6col text-center">
          <div class="item"> <a href="#"><img src="images/clients/iita.jpg" alt=""></a></div>
          <div class="item"> <a href="#"><img src="images/clients/kfs.jpg" alt=""></a></div>
          <div class="item"> <a href="#"><img src="images/clients/syngenta.jpg" alt=""></a></div>
          <div class="item"> <a href="#"><img src="images/clients/usaid.jpg" alt=""></a></div>
          <div class="item"> <a href="#"><img src="images/clients/world-vision.jpg" alt=""></a></div>
